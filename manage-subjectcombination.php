...
<html lang="en">
    <head>
        ...
        <title>IMSEC Admin Manage Subjects Combination</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
            							<li><a href="dashboard.php"><i class="fa fa-home"></i><span style="color:black;"> Home</span></a></li>
                                        <li><span style="color:black;"> Subjects</span></li>
            							<li class="active"><span style="color:black;">Manage Subjects Combination</span></li>
            						</ul>
                                </div>
